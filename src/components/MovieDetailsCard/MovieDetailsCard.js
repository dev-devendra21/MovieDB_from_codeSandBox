        ...
        <>
            <div className="movie-details-card">
                <section className="movie-details-card-description">
                    <div className='movie-description'>
                        ...
                        <div>
                            ...
                            <h1 className='movie-rating'>Rating: {description.vote_average?.toFixed(1)}</h1>
                            <div className='runtime-and-genre'>
                                <p className='runtime'>{description.runtime} runtime </p>
                                <ul className='genre'> {description.genres.map((genre) => (<li>{genre.name}</li>))}</ul>
                            </div>
                            <p className='release-date'>Release Date: {date.toDateString()}</p>
                        </div>
                    </div>
                    <div>
                ...
                <section className='backdrop-container'>
                    <img src={backdropSrc} className='backdrop-img' alt={description.title} />
                </section>
            </div>
        </>
    )
